...
<input type="button" onclick="window.location='/LoginMavenSpringMVC/serviceMaster/form'"  value="Service Masters"/><br><br>
...
<input type="button" onclick="window.location='/LoginMavenSpringMVC/demo/duplicate'"  value="RowDuplication"><br><br>

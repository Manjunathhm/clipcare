...
<body>
  ...
  <div class="container-fluid">
    ...
    <f:form class="form-horizontal" id="registrationform" action="save" modelAttribute="patient" method="post">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="gridSystemModalLabel">Search Patient List</h4>
      </div>
                           ...
                           <table id="PatientsList" class="table  table-bordered table-hover borderpanel"> 
                            <thead >
                             ...
                             <c:forEach var="pat" items="${patients}" varStatus="status">
												...
												<tr>
													<td class="text-center">${pat.patientId}</td>
													<td class="text-center">${pat.firstName}</td>
													<td class="text-center">${pat.middleName}</td>
													<td class="text-center">${pat.lastName}</td>
													<td class="text-center">${pat.mobileNumber1}</td>
													<td class="text-center">${pat.emailId1}</td>
													<td class="text-center" data-dismiss="modal"><i class="glyphicon glyphicon-ok" id="select" style="color:#006699" data-toggle="tooltip" title="Edit"></i></td>					
		 ...
		 <f:form modelAttribute="hospital">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-2">
                    <f:input type="text" class="form-control input-sm field_color" readonly="true" path="patientId" placeholder="Patient ID"/>
                </div>
            </div>
            ...
            <div id=minorinfo>
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-2">
                        <f:input type="text" path="guardian.guardianId" class="form-control input-sm field_color" readonly="true" placeholder="Id"/>
                    </div>
                    
                    <div class="col-sm-3 col-md-2">
                        <button type=button class="btn btn-sm btn-success" data-toggle="modal" data-target=".abcd">
                        <span id="SearchParentsInfo" class="glyphicon glyphicon-search"></span></button>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-2 ">
                    <f:input type="number" class="form-control input-sm field_color" path="currentAddress.pincode" placeholder="Pin code"/>
                </div>
            </div>
 ...
 <div class=row>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-2 ">
                    <f:input type="number" class="form-control input-sm field_color" path="permanentAddress.pincode" placeholder="pin code"/>
                </div>
            </div>
            ...
            <div class="row buttons">
                <div class="col-sm-12 col-md-12 text-center">
                  	<button class="btn btn-default button" id="cancel" onclick="window.history.go(-1);">Cancel</button>
    ...
    <script>
        $(document).ready(function() {
        	$('[name="minor"]').bootstrapSwitch();
            var state=$('[name="minor"]').is(":unchecked") ?  false : true;
            console.log("printing State of switch "+state);
                     if(state){
                    // console.log("method inside if "+ state);
                     $('#minorinfo').show();
                     }else{
                         $('#minorinfo').hide();
                     }
           // $.fn.bootstrapSwitch.defaults.state = false;
        $('input[name="minor"]').on('switchChange.bootstrapSwitch', function (event, state) {
        ...
        $('#PatientsList tbody').on( 'click', 'tr', function () {
        	...
        	$('[name="guardian.guardianId"]').val(data[0]);
        	$('[name="guardian.firstName"]').val(data[1]);
        	$('[name="guardian.middleName"]').val(data[2]);
        	$('[name="guardian.lastName"]').val(data[3]);
        	$('[name="guardian.mobileNumber1"]').val(data[4]);
        	$('[name="guardian.emailId1"]').val(data[5]); 
